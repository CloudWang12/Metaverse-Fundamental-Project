...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_MRUKMeshSegment;
class UScriptStruct* FMRUKMeshSegment::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_MRUKMeshSegment.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_MRUKMeshSegment.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMRUKMeshSegment, (UObject*)Z_Construct_UPackage__Script_MRUtilityKit(), TEXT("MRUKMeshSegment"));
	}
	return Z_Registration_Info_UScriptStruct_MRUKMeshSegment.OuterSingleton;
}
template<> MRUTILITYKIT_API UScriptStruct* StaticStruct<FMRUKMeshSegment>()
{
	return FMRUKMeshSegment::StaticStruct();
}
...
{
	if (!Z_Registration_Info_UScriptStruct_MRUKMeshSegment.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_MRUKMeshSegment.InnerSingleton, Z_Construct_UScriptStruct_FMRUKMeshSegment_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_MRUKMeshSegment.InnerSingleton;
}
...
// Begin Class UMRUKBPLibrary Function ComputeRoomBoxGrid
struct Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics
{
	struct MRUKBPLibrary_eventComputeRoomBoxGrid_Parms
	{
		const AMRUKRoom* Room;
		int32 MaxPointsCount;
		double PointsPerUnitX;
		double PointsPerUnitY;
		TArray<FVector> ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "MR Utility Kit" },
		{ "Comment", "/**\n\x09 * Compute a grid by taking into account the room box geometry. E.g. create evenly spaced points on ceiling, floor and walls.\n\x09 * @param Room The room to use\n\x09 * @param MaxPointsCount The maximum number of points\n\x09 * @param PointsPerUnitX The density of points on the X axis\n\x09 * @param PointsPerUnitY The density of points on the Y axis\n\x09 * @param bIncludeFloor Whether or not to include the floor\n\x09 * @param bIncludeCeiling Whether or not to include the ceiling\n\x09 * @param bIncludeWalls Whether or not to include the walls\n\x09 * @return The computed points\n\x09 */" },
		{ "CPP_Default_PointsPerUnitX", "1.000000" },
		{ "CPP_Default_PointsPerUnitY", "1.000000" },
		{ "ModuleRelativePath", "Public/MRUtilityKitBPLibrary.h" },
		{ "ToolTip", "Compute a grid by taking into account the room box geometry. E.g. create evenly spaced points on ceiling, floor and walls.\n@param Room The room to use\n@param MaxPointsCount The maximum number of points\n@param PointsPerUnitX The density of points on the X axis\n@param PointsPerUnitY The density of points on the Y axis\n@param bIncludeFloor Whether or not to include the floor\n@param bIncludeCeiling Whether or not to include the ceiling\n@param bIncludeWalls Whether or not to include the walls\n@return The computed points" },
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_Room = { "Room", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MRUKBPLibrary_eventComputeRoomBoxGrid_Parms, Room), Z_Construct_UClass_AMRUKRoom_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Room_MetaData), NewProp_Room_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_MaxPointsCount = { "MaxPointsCount", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MRUKBPLibrary_eventComputeRoomBoxGrid_Parms, MaxPointsCount), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FDoublePropertyParams Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_PointsPerUnitX = { "PointsPerUnitX", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MRUKBPLibrary_eventComputeRoomBoxGrid_Parms, PointsPerUnitX), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FDoublePropertyParams Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_PointsPerUnitY = { "PointsPerUnitY", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MRUKBPLibrary_eventComputeRoomBoxGrid_Parms, PointsPerUnitY), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MRUKBPLibrary_eventComputeRoomBoxGrid_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_Room,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_MaxPointsCount,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_PointsPerUnitX,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_PointsPerUnitY,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_ReturnValue_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMRUKBPLibrary, nullptr, "ComputeRoomBoxGrid", nullptr, nullptr, Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::MRUKBPLibrary_eventComputeRoomBoxGrid_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::MRUKBPLibrary_eventComputeRoomBoxGrid_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UMRUKBPLibrary::execComputeRoomBoxGrid)
{
	P_GET_OBJECT(AMRUKRoom,Z_Param_Room);
	P_GET_PROPERTY(FIntProperty,Z_Param_MaxPointsCount);
	P_GET_PROPERTY(FDoubleProperty,Z_Param_PointsPerUnitX);
	P_GET_PROPERTY(FDoubleProperty,Z_Param_PointsPerUnitY);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(TArray<FVector>*)Z_Param__Result=UMRUKBPLibrary::ComputeRoomBoxGrid(Z_Param_Room,Z_Param_MaxPointsCount,Z_Param_PointsPerUnitX,Z_Param_PointsPerUnitY);
	P_NATIVE_END;
}
// End Class UMRUKBPLibrary Function ComputeRoomBoxGrid
...
void UMRUKBPLibrary::StaticRegisterNativesUMRUKBPLibrary()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "ComputeRoomBoxGrid", &UMRUKBPLibrary::execComputeRoomBoxGrid },
...
struct Z_Construct_UClass_UMRUKBPLibrary_Statics
{
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UMRUKBPLibrary_ComputeCentroid, "ComputeCentroid" }, // 225782048
		{ &Z_Construct_UFunction_UMRUKBPLibrary_ComputeDirectionAwayFromClosestWall, "ComputeDirectionAwayFromClosestWall" }, // 199621746
		{ &Z_Construct_UFunction_UMRUKBPLibrary_ComputeRoomBoxGrid, "ComputeRoomBoxGrid" }, // 2315894380
		{ &Z_Construct_UFunction_UMRUKBPLibrary_ConstructTexture2D, "ConstructTexture2D" }, // 2181242310
		{ &Z_Construct_UFunction_UMRUKBPLibrary_GetMatrixColumn, "GetMatrixColumn" }, // 4236342762
		{ &Z_Construct_UFunction_UMRUKBPLibrary_IsUnrealEngineMetaFork, "IsUnrealEngineMetaFork" }, // 1186758201
		{ &Z_Construct_UFunction_UMRUKBPLibrary_LoadGlobalMeshFromDevice, "LoadGlobalMeshFromDevice" }, // 866898327
		{ &Z_Construct_UFunction_UMRUKBPLibrary_LoadGlobalMeshFromJsonString, "LoadGlobalMeshFromJsonString" }, // 55885820
		{ &Z_Construct_UFunction_UMRUKBPLibrary_RecalculateProceduralMeshAndTangents, "RecalculateProceduralMeshAndTangents" }, // 542015450
		{ &Z_Construct_UFunction_UMRUKBPLibrary_SetScaleRecursivelyAdjustingForRotation, "SetScaleRecursivelyAdjustingForRotation" }, // 2558398649
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMRUKMeshSegment::StaticStruct, Z_Construct_UScriptStruct_FMRUKMeshSegment_Statics::NewStructOps, TEXT("MRUKMeshSegment"), &Z_Registration_Info_UScriptStruct_MRUKMeshSegment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMRUKMeshSegment), 3173950033U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMRUKLoadFromDevice, UMRUKLoadFromDevice::StaticClass, TEXT("UMRUKLoadFromDevice"), &Z_Registration_Info_UClass_UMRUKLoadFromDevice, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKLoadFromDevice), 4157258716U) },
		{ Z_Construct_UClass_UMRUKBPLibrary, UMRUKBPLibrary::StaticClass, TEXT("UMRUKBPLibrary"), &Z_Registration_Info_UClass_UMRUKBPLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKBPLibrary), 2746360149U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_3548082916(TEXT("/Script/MRUtilityKit"),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
