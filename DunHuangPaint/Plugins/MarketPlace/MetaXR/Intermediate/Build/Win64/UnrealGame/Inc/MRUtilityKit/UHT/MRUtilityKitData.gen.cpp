...
struct Z_Construct_UClass_UMRUKAnchorData_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		...
		{ "IncludePath", "MRUtilityKitData.h" },
		{ "ModuleRelativePath", "Public/MRUtilityKitData.h" },
		{ "ToolTip", "A datastrcture to hold the data of a single anchor. It also provides functions to load the data from device or json." },
	};
#endif // WITH_METADATA
	static UObject* (*const DependentSingletons[])();
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitData_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		...
		{ Z_Construct_UClass_UMRUKAnchorData, UMRUKAnchorData::StaticClass, TEXT("UMRUKAnchorData"), &Z_Registration_Info_UClass_UMRUKAnchorData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKAnchorData), 334671316U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitData_h_2524503158(TEXT("/Script/MRUtilityKit"),
