...
void EmptyLinkFunctionForGeneratedCodeOculusXRAnchors_init() {}
	...
	OCULUSXRANCHORS_API UFunction* Z_Construct_UDelegateFunction_OculusXRAnchors_OculusXR_LatentAction_GetSharedAnchorsFromGroup_Complete__DelegateSignature();
	...
	OCULUSXRANCHORS_API UFunction* Z_Construct_UDelegateFunction_OculusXRAnchors_OculusXR_LatentAction_ShareAnchorsWithGroups_Complete__DelegateSignature();
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_OculusXRAnchors()
	{
		if (!Z_Registration_Info_UPackage__Script_OculusXRAnchors.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_OculusXRAnchors_OculusXR_LatentAction_GetSharedAnchorsFromGroup_Complete__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_OculusXRAnchors_OculusXR_LatentAction_ShareAnchorsWithGroups_Complete__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_OculusXRAnchors(Z_Construct_UPackage__Script_OculusXRAnchors, TEXT("/Script/OculusXRAnchors"), Z_Registration_Info_UPackage__Script_OculusXRAnchors, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xCD14EC90, 0x01D8BD96));
