...
struct Z_Construct_UClass_AMRUtilityKitPositionGenerator_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AMRUtilityKitPositionGenerator_GenerateRandomPositionsOnSurface, "GenerateRandomPositionsOnSurface" }, // 2097716705
		{ &Z_Construct_UFunction_AMRUtilityKitPositionGenerator_GenerateRandomPositionsOnSurfaceInRoom, "GenerateRandomPositionsOnSurfaceInRoom" }, // 3927336301
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitPositionGenerator_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMRUKRandomSpawnSettings::StaticStruct, Z_Construct_UScriptStruct_FMRUKRandomSpawnSettings_Statics::NewStructOps, TEXT("MRUKRandomSpawnSettings"), &Z_Registration_Info_UScriptStruct_MRUKRandomSpawnSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMRUKRandomSpawnSettings), 791983811U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMRUtilityKitPositionGenerator, AMRUtilityKitPositionGenerator::StaticClass, TEXT("AMRUtilityKitPositionGenerator"), &Z_Registration_Info_UClass_AMRUtilityKitPositionGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMRUtilityKitPositionGenerator), 2635494736U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitPositionGenerator_h_2755392515(TEXT("/Script/MRUtilityKit"),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitPositionGenerator_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitPositionGenerator_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitPositionGenerator_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitPositionGenerator_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
