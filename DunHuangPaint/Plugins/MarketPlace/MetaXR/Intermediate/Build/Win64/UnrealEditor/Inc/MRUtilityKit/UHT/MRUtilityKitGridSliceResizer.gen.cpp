...
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitGridSliceResizer_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EMRUKScaleCenterMode_StaticEnum, TEXT("EMRUKScaleCenterMode"), &Z_Registration_Info_UEnum_EMRUKScaleCenterMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1295164054U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMRUKGridSliceResizerComponent, UMRUKGridSliceResizerComponent::StaticClass, TEXT("UMRUKGridSliceResizerComponent"), &Z_Registration_Info_UClass_UMRUKGridSliceResizerComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKGridSliceResizerComponent), 3461588850U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitGridSliceResizer_h_257710922(TEXT("/Script/MRUtilityKit"),
