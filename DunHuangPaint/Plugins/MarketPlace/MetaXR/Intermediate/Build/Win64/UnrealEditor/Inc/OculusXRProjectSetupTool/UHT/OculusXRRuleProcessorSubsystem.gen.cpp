...
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_OculusXRProjectSetupTool_Public_OculusXRRuleProcessorSubsystem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOculusXRRuleProcessorSubsystem, UOculusXRRuleProcessorSubsystem::StaticClass, TEXT("UOculusXRRuleProcessorSubsystem"), &Z_Registration_Info_UClass_UOculusXRRuleProcessorSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRRuleProcessorSubsystem), 37897912U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_OculusXRProjectSetupTool_Public_OculusXRRuleProcessorSubsystem_h_2310506884(TEXT("/Script/OculusXRProjectSetupTool"),
