...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_OculusXRAnchor;
class UScriptStruct* FOculusXRAnchor::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_OculusXRAnchor.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_OculusXRAnchor.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FOculusXRAnchor, (UObject*)Z_Construct_UPackage__Script_OculusXRAnchors(), TEXT("OculusXRAnchor"));
	}
	return Z_Registration_Info_UScriptStruct_OculusXRAnchor.OuterSingleton;
}
template<> OCULUSXRANCHORS_API UScriptStruct* StaticStruct<FOculusXRAnchor>()
{
	return FOculusXRAnchor::StaticStruct();
}
...
{
	if (!Z_Registration_Info_UScriptStruct_OculusXRAnchor.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_OculusXRAnchor.InnerSingleton, Z_Construct_UScriptStruct_FOculusXRAnchor_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_OculusXRAnchor.InnerSingleton;
}
...
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_OculusXRAnchors_Public_OculusXRAnchorTypes_h_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		...
		{ FOculusXRAnchor::StaticStruct, Z_Construct_UScriptStruct_FOculusXRAnchor_Statics::NewStructOps, TEXT("OculusXRAnchor"), &Z_Registration_Info_UScriptStruct_OculusXRAnchor, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOculusXRAnchor), 1910554030U) },
		{ FOculusXRSpaceQueryInfo::StaticStruct, Z_Construct_UScriptStruct_FOculusXRSpaceQueryInfo_Statics::NewStructOps, TEXT("OculusXRSpaceQueryInfo"), &Z_Registration_Info_UScriptStruct_OculusXRSpaceQueryInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOculusXRSpaceQueryInfo), 1976457817U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_OculusXRAnchors_Public_OculusXRAnchorTypes_h_2452990211(TEXT("/Script/OculusXRAnchors"),
